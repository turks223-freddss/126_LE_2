      ...
      <div className="bg-gray-900 rounded-xl p-6 w-full max-w-md relative animate-fade-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-4 pt-4">
            <button
              type="submit"
              className={`flex-1 py-2 px-4 rounded-lg font-medium text-white ${type === 'income' ? 'bg-green-600 hover:bg-green-700' : 'bg-red-600 hover:bg-red-700'} transition-colors`}
            >
              Add {type === 'income' ? 'Income' : 'Expense'}
            </button>
            <button
